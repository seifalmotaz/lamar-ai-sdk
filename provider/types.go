...
type GenerateResult struct {
	...
	// Grounding contains citation and source attribution from grounded responses.
	// This is populated by providers that support grounding (e.g., Gemini with google_search).
	// It is nil for providers/responses that don't support or return grounding.
	Grounding *GroundingMetadata

	// CodeExecutions contains server-side code execution results.
	// This is populated by providers that support code execution (e.g., Gemini with code_execution).
	// It is nil for providers/responses that don't support code execution.
...
// GroundingSource represents a source document or URL used for grounding.
...
// Citation links a text segment in the response to its supporting sources.
type Citation struct {
	...
	SourceIndices []int  // References to GroundingSource array
}
...
type CodeExecution struct {
	...
	Outcome  string // Execution outcome: "OUTCOME_OK", "OUTCOME_FAILED", "OUTCOME_DEADLINE_EXCEEDED"
	Output   string // stdout on success, stderr or error description on failure
}
