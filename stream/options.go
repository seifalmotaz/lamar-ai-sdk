...
type Config struct {
	...
	// Timeout overrides the default streaming timeout.
...
// Option is a functional option for configuring streaming.
...
// WithTimeout sets a custom timeout for the streaming request.
